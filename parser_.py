...
file_pointer = open('data/protein_ids.txt', 'r')
while True:
        next_line = file_pointer.readline()
        aa_seq = get_fasta(next_line)
        print(len(aa_seq))
...
"""
# Read and get pdb id's from dataset
dataset = open('data/raw/training_30', 'r')
read_protein_from_file_ids(dataset)
"""
